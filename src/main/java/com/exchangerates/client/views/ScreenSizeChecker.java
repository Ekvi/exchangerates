...
public class ScreenSizeChecker extends Widget {
    ...
    public int getChartHeight() {
        ...
        if(Window.getClientHeight() <= 980 && Window.getClientHeight() >= 890) {
            height = 180;
    ...
    public String getScrollPanelHeight() {
        String height = "";
        if(Window.getClientHeight() > 910 && Window.getClientHeight() < 960 ) {
            height = "500px";
        } else if(Window.getClientHeight() > 880 && Window.getClientHeight() < 910 ) {
            height = "473px";
        } else if(Window.getClientHeight() > 855 && Window.getClientHeight() < 870 ) {
            height = "440px";
        } else if(Window.getClientHeight() > 820 && Window.getClientHeight() < 855 ) {
            height = "420px";
            ...
            height = "350px";
        } else if(Window.getClientHeight() > 695 && Window.getClientHeight() < 750 ) {
            height = "320px";
        } else if(Window.getClientHeight() > 660 && Window.getClientHeight() < 695) {
            height = "290px";
        } else if(Window.getClientHeight() > 630 && Window.getClientHeight() < 660) {
            height = "265px";
        } else if(Window.getClientHeight() > 615 && Window.getClientHeight() < 630) {
            height = "230px";
        } else if(Window.getClientHeight() > 580 && Window.getClientHeight() < 615) {
            height = "225px";
        }
    ...
    public String getStackLayoutPanelSize() {
        ...
        } else if(Window.getClientHeight() > 910 && Window.getClientHeight() < 920 ) {
            height = Window.getClientHeight()/1.55 + "px";
        } else if(Window.getClientHeight() > 890 && Window.getClientHeight() < 910 ) {
            height = Window.getClientHeight()/1.52 + "px";
        } else if(Window.getClientHeight() > 880 && Window.getClientHeight() < 890 ) {
            height = Window.getClientHeight()/1.50 + "px";
        ...
        } else if(Window.getClientHeight() > 820 && Window.getClientHeight() < 830 ) {  //1280x960  big icons
            height = Window.getClientHeight()/1.38 + "px";
        ...
        } else if(Window.getClientHeight() > 730 && Window.getClientHeight() < 740 ) {  //1152x864 big icons
            height = Window.getClientHeight()/1.25 + "px";
        ...
        } else if(Window.getClientHeight() > 660 && Window.getClientHeight() < 695 ) {  //1366x768  1360x768  1280x768
        ...
        } else if(Window.getClientHeight() > 630 && Window.getClientHeight() < 635 ) {
            height = Window.getClientHeight()/1.07 + "px";
        } else if(Window.getClientHeight() > 615 && Window.getClientHeight() < 630 ) {
